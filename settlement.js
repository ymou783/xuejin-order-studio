...
function settlementSvg() {
  ...
  const record = `总撤离 ${totalGames}撤 · 成功撤离 ${successCount}撤`;
  ...
  return `<svg xmlns="http://www.w3.org/2000/svg" width="1000" height="1600" viewBox="0 0 1000 1600">
    <defs><pattern id="settleGrain" width="12" height="12" patternUnits="userSpaceOnUse"><circle cx="2" cy="3" r=".7" fill="#6d5946" opacity=".08"/><circle cx="9" cy="8" r=".5" fill="#6d5946" opacity=".06"/></pattern><filter id="settleShadow" x="-20%" y="-20%" width="140%" height="140%"><feDropShadow dx="0" dy="18" stdDeviation="18" flood-color="#57443c" flood-opacity=".22"/></filter><style>.ink{fill:#29232b;font-family:'Noto Sans SC','Microsoft YaHei',sans-serif}.label{fill:#29232b;font-size:30px;font-weight:800}.value{fill:#4d3c4c;font-size:28px;font-family:'DM Mono','Microsoft YaHei',monospace}.icon{font-size:32px}.small{fill:#806f79;font-size:20px;font-family:'Noto Sans SC','Microsoft YaHei',sans-serif}.red{fill:#bd5148}.green{fill:#6f9872;font-weight:700}.title{fill:#29232b;font-size:64px;font-weight:800;letter-spacing:8px}</style></defs>
    ...
    <line x1="180" y1="782" x2="820" y2="782" stroke="#c9beb1" stroke-dasharray="5 6"/><text x="190" y="820" class="label">▣ 订单号</text><text x="810" y="820" text-anchor="end" class="value" font-size="23">${escapeSvg(safeOrder)}</text><text x="190" y="858" class="small">备注：${escapeSvg(companionTrail)}</text>${row(900,"▥","战绩",record)}${row(950,"◉","撤离率",rate)}${row(1000,"¤","共得吃",eaten)}<text x="190" y="1056" class="label">▦ 日期</text><text x="810" y="1056" text-anchor="end" class="value">${date.long}</text>
    ...
    <text x="500" y="1275" text-anchor="middle" class="red" font-size="24" font-weight="700">感谢板板支持</text><line x1="180" y1="1308" x2="820" y2="1308" stroke="#bd5148" stroke-opacity=".35"/><text x="190" y="1344" class="red" font-size="21" font-weight="700">本次服务评价</text><text x="190" y="1382" class="small">操作技术</text><text x="810" y="1382" text-anchor="end" class="small green">${escapeSvg(technical)}</text><text x="190" y="1420" class="small">服务态度</text><text x="810" y="1420" text-anchor="end" class="small green">${escapeSvg(attitude)}</text><text x="190" y="1458" class="small">老板备注</text><text x="810" y="1458" text-anchor="end" class="small">${escapeSvg(note)}</text><text x="500" y="1518" text-anchor="middle" class="red" font-size="21">感谢您的评价</text>
  </svg>`;
}
